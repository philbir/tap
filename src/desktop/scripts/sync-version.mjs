...
//   node src/desktop/scripts/sync-version.mjs 0.2.0
...
// 1. src/desktop/package.json
// 2. src/desktop/src-tauri/tauri.conf.json
for (const file of [
...
// 3. src/desktop/src-tauri/Cargo.toml — patch only the [package]
...
// 4. src/desktop/src-tauri/Cargo.lock — patch ONLY the
