...
/// <c>collections/&lt;slug&gt;/...nested-folders.../*</c> — requests (<c>*.req.md</c>) and,
/// optionally, auth profiles (<c>*.auth.md</c>) that want the collection's variables and
/// stages in scope. The collection's own file is <c>collections/&lt;slug&gt;/_collection.md</c>.
...
public static class CollectionLocator
{
    ...
    /// <c>collections/</c> or its owning collection has no <c>_collection.md</c>.</summary>
