 ...
 * which sub-tab is open, which body view is showing, and anything else in that class.
 *
 ...
 *
 * Like drafts, this is in-memory only: a view choice stays "for this session", it just no
